...
namespace LTU_MATE_ROV_2019_2020_Control_Software.Hardware {
	...
	public abstract class IReadableDevice<T1, T2> : IDevice<T1, T2>
		...
		public override byte[] SendUpdate => new byte[1] { 0b11000000 };
	...
	public override byte[] SendUpdate => new byte[1] { 0b11111110 };
	...
	where T8 : IDataType, new() {
		...
		public override byte[] SendUpdate => new byte[1] { 0b11111111 };
